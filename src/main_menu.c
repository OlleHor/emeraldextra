...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    gSprites[spriteId].pos1.x = 88;
    gSprites[spriteId].pos1.y = 48;
    gSprites[spriteId].invisible = FALSE;
    gSprites[spriteId].data[0] = 0;

    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_MASQUERAIN);
...
{
    return CreatePicSprite2(SPECIES_MASQUERAIN, SHINY_ODDS, 0, 1, a, b, 14, -1);
}
